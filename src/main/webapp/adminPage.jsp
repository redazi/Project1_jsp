    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        ...
        <div class="circle-tile-content dark-blue">
          ...
          <a class="circle-tile-footer" href="conreserv.jsp">plus détaille<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div>
        <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        <a href="#"><div class="circle-tile-heading dark-blue"><i class="fa fa-users fa-fw fa-3x"></i></div></a>
        <div class="circle-tile-content dark-blue">
          <div class="circle-tile-description text-faded">Reservations confirmées</div>
          <div class="circle-tile-number text-faded "><%=c1 %></div>
          <a class="circle-tile-footer" href="histo.jsp" >Plus détaille<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div>
           <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        <a href="#"><div class="circle-tile-heading dark-blue"><i class="fa fa-users fa-fw fa-3x"></i></div></a>
        <div class="circle-tile-content dark-blue">
          <div class="circle-tile-description text-faded">Salles listées</div>
          <div class="circle-tile-number text-faded "><%=c11 %></div>
           <a class="circle-tile-footer" href="gerersalle.jsp">plus détaille<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div>
      <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        ...
        <div class="circle-tile-content dark-blue">
          ...
          <a class="circle-tile-footer" href="gererclient.jsp">plus détaille<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div>
